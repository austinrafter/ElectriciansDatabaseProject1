...
const Employee_Form = (props) => {
    ...
    APIServiceThree.InsertEmployee({first_name,last_name,address,city,state,zipcode,position,pay_rate,years_employed,first_name_gm,last_name_gm,address_gm,city,state_gm,zipcode_gm,position_gm})
