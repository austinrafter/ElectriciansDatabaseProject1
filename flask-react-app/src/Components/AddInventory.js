...
const AddInventory = (props) => {
    ...
    APIServiceTwelve.InsertInventory({material_name,cost_per_unit,weight_per_unit ,first_name,last_name,address,city,state,zipcode,position,pay_rate,years_employed})
