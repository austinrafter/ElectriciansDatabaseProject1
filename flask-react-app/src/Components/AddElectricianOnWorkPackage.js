...
const AddElectricianOnWorkPackage = (props) => {
    ...
    APIServiceFourteen.InsertElectricianToWorkPackage({electricians_first_name,electricians_last_name,electricians_position,electricians_address, work_package_name, site_name ,first_name,last_name,position,address,city,state,zip})
