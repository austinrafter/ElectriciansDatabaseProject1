...
import APIServiceSeventeen from '../Components/APIServiceSeventeen.js'
import MaterialInWorkPackageList from '../Components/MaterialInWorkPackageList';


const DeleteMaterialOffWorkPackage = (props) => {
    ...
    APIServiceSeventeen.DeleteMaterialFromWorkPackage({material_name,work_package_name,site_name,amount_alloted, amount_used,first_name,last_name,position,address,city,state,zipcode})
      ...
      return (
           ...
           <h2> "Enter the information about the material to delete on the job" </h2>
             <form onSubmit = {handleSubmit} >
                     ...
                     >
                     Delete material from work package</button>
...
export default DeleteMaterialOffWorkPackage;
