...
const DeleteMaterialOffWorkPackage = (props) => {
    ...
    APIServiceSeventeen.DeleteMaterialFromWorkPackage({material_name,work_package_name,site_name,amount_alloted, amount_used,first_name,last_name,position,address,city,state,zip})
