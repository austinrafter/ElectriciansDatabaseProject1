...
import APIServiceFifteen from '../Components/APIServiceFifteen.js'
import ElectricianOnWorkPackageList from '../Components/ElectricianOnWorkPackageList';


const DeleteElectricianOffWorkPackage = (props) => {
    ...
    const handleSubmit=(event)=>{
      ...
      return (
           <div>
           <h2> "Enter information about the electrician and work package to delete" </h2>
             <form onSubmit = {handleSubmit} >

                     <label htmlFor="electricians_first_name" className="form-label">Electrician First Name</label>
                     <input
                     type="text"
                     ...
                     />
                      ...
                      <label htmlFor="electricians_last_name" className="form-label">Electrician Last Name</label>
                      <input
                      type="text"
                      className="form-control"
                      ...
                      <label htmlFor="electricians_address" className="form-label">Electrician Address</label>
                      <input
                      type="text"
                      className="form-control"
                     ...
                     >
                     Delete electrician from work package</button>
...
export default DeleteElectricianOffWorkPackage;
